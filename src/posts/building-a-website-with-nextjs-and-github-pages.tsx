...
Now, head back to your repo's **Pages** settings and enter your custom domain. If GitHub can verify your DNS, then you are ready to go and share your shiny new domain with the world. Otherwise, it may be time to call a professional.

## Wrapping Up

What started as a vague thought, *“maybe I should have a website”,*  turned into a full setup with Next.js, GitHub Pages, and a custom domain powered by Cloudflare. It wasn't the most straightforward path, and definitely not the most flexible, but it got the job done with minimal cost and without needing a full-blown server.

It's not perfect, and it'll probably keep evolving (as all good side projects do), but it's live, it's mine, and it works. And if you've made it this far, maybe yours does too.
`;
...
const metadata: BlogPostMetadata = {
  ...
  mainImage: "/posts/building-a-website-with-nextjs-and-github-pages/cover.jpg",
  title: "Building a website with Next.js and GitHub Pages",
  description: "Walkthrough the process of building a website with Next.js, deploying it on GitHub Pages, and connecting it to a custom domain.",
  author: author,
